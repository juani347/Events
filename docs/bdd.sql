...
CREATE TABLE participante(
    /* ACA TODOS LOS CAMPOS DEL EXCEL. se completan los correspondientes al participante */
...
VALUES
    ('Fiesa','2021-03-16','2021-03-17', 0, 0, '-38.00042,-57.5562','La Feria Internacional de Educación Superior Argentina (FIESA) es un encuentro internacional de Instituciones de Educación Superior que tendrá a la Universidad Nacional de Mar del Plata y a la Ciudad de Mar del Plata como anfitrionas y reunirá a referentes de todo el mundo.');
